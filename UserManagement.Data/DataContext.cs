...
public class DataContext : IdentityDbContext<User, IdentityRole<long>, long>, IDataContext
{
    private static long _nextUserId = 12;
    private readonly IPasswordHasher<User> _passwordHasher;
    private readonly ILookupNormalizer _lookupNormalizer;

    public DataContext(IPasswordHasher<User> passwordHasher, ILookupNormalizer lookupNormalizer)
    {
